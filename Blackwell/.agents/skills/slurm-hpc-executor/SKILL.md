...
Use this skill when the task involves Slurm commands, cluster-safe execution, batch scripts, or environment bootstrapping for Blackwell GPU work.
...
5. Make the Blackwell device expectation explicit in the command examples.
