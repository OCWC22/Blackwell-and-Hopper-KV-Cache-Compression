...
- Require the benchmark ladder to stay honest: `BF16`, `FP8`, then packed FP4-like variants.
- Push for stable seeds and machine-readable results.
- Watch for documentation or claims that understate the dequant and host-path bottlenecks.
